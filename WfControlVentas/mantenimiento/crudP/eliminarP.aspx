<%@ Page Title="" Language="C#" MasterPageFile="~/master/submenu.Master" AutoEventWireup="true" CodeBehind="eliminarP.aspx.cs" Inherits="WfControlVentas.mantenimiento.crudP.eliminarP" %>
        ...
        <div class="d-flex justify-content-center align-items-center mt-5">
            <div class="col-11 col-md-8 rounded shadow p-3 p-sm-4">
                <div>
                    ...
                    <p class="text-center">¿Estas seguro de eliminar este producto?</p>

                    <div class="overflow-auto ps-3 pe-3">
                        <asp:GridView ID="GvProductoE" runat="server" CssClass="table table-dark table-bordered table-hover text-center"></asp:GridView>
                    </div>
